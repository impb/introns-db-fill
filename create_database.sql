...
ALTER TABLE  intronsAUTO_INCREMENT = 1;
ALTER TABLE  coding_exonsAUTO_INCREMENT = 1;
ALTER TABLE  isoformsAUTO_INCREMENT = 1;
ALTER TABLE  genesAUTO_INCREMENT = 1;
ALTER TABLE  sequencesAUTO_INCREMENT = 1;
ALTER TABLE  organismsAUTO_INCREMENT = 1;
ALTER TABLE  chromosomesAUTO_INCREMENT = 1;
ALTER TABLE  intron_typesAUTO_INCREMENT = 1;
ALTER TABLE  tax_groups2AUTO_INCREMENT = 1;
ALTER TABLE  tax_groups1AUTO_INCREMENT = 1;
ALTER TABLE  tax_kingdomsAUTO_INCREMENT = 1;
ALTER TABLE  orthologous_groupsAUTO_INCREMENT = 1;
